...
\begin{slide}{Methods: Weight Update}
  ...
  \begin{tikzpicture}[scale=0.8]
    ...
    % Loss function
    \draw [domain=-2.4:3.1, samples=200] plot (\x, {-0.05*\x^7 + 0.15*\x^6 + 0.25*\x^5 - 0.7*\x^4 - 0.35*\x^3 + 0.5*\x^2 + 0.55*\x + 1.55});
...
\begin{slide}{Concepts: Model Capacity}
  ...
  \begin{tikzpicture}[
    ...
    % Function
    \draw [domain=0.1:3, samples=100, dotted] plot (\x, {f(\x)});
...
\begin{slide}{Concepts: Model Capacity}
  ...
  \begin{tikzpicture}[
    ...
    \draw [domain=0:2.8, samples=800, /pgf/fpu,/pgf/fpu/output format=fixed] plot (\x, {-0.6904015551*\x^8 + 10.89843224*\x^7 - 69.51522312*\x^6 + 229.1182621*\x^5 - 413.7646904*\x^4 + 399.5064624*\x^3 - 185.9487975*\x^2 + 33.50595212*\x + 7.169728633*10^-8});
  \end{tikzpicture}
