...
\begin{slide}{Definition I}
  \centering
  \Large
  Machine Learning is \only<2>{really }cool.
\end{slide}
...
\begin{slide}{The Task, $T$}
  ...
  %   \item Predictive Policing %Placing crime suspects into different threat levels based on crime history
  % \end{itemize}
\end{slide}
...
\begin{slide}{The Task, $T$}
  ...
  % \pause
  % \begin{itemize}
  %   \item Algorithmic Trading % Predict future prices given the current and past state of the market. Generally anything that has to do with money.
  %   \item Predicting the market price of a house % Given its features of size, age, pool
